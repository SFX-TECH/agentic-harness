...
- **[`PATTERNS.md`](PATTERNS.md)**: the orchestration patterns: the Block 0 audit, one-orchestrator-plus-sequential-sub-agents, completing a rate-limited sub-agent's remainder, the cross-model review gate, phase-gate discipline.
...
- **Local Transcriber**: a local-first, on-device AI desktop tool that turns any audio or video into text on your own machine. [Local Transcriber »](https://github.com/SFX-TECH/local-transcriber)
